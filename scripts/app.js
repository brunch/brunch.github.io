...
require.register("browser-resolve/empty", function(exports, require, module) {
...
require.register("jade/runtime", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "jade");
  (function() {
...
;require.register("scripts/plugins", function(exports, require, module) {
'use strict';
...
require.register("scripts/skeletons", function(exports, require, module) {
'use strict';
...
var Body = React.createClass({
  ...
  componentWillMount: function componentWillMount() {
    ...
    fetch('/skeletons.json').then(function (x) {
      return x.json();
    }).then(function (x) {
