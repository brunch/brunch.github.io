...
require.register("compare.jade", function(exports, require, module) {
...
;require.register("examples.jade", function(exports, require, module) {
var __templateData = function template(locals) {
var buf = [];
var jade_mixins = {};
var jade_interp;
...
;require.register("plugins.jade", function(exports, require, module) {
var __templateData = function template(locals) {
var buf = [];
var jade_mixins = {};
var jade_interp;
...
var Body = React.createClass({
  ...
  componentWillMount: function componentWillMount() {
    ...
    fetch('/plugins.json').then(function (x) {
      return x.json();
    }).then(function (x) {
  ...
  categorySortedPlugins: function categorySortedPlugins() {
  ...
  render: function render() {
    var pluginItems = this.categorySortedPlugins().map(function (category) {
      ...
      var subcatItems = category.subcategories.map(function (subcategory) {
        var subcatItem = React.createElement(
          'tr',
        ...
        var pluginItems = subcategory.plugins.map(function (plugin, i) {
          ...
          return React.createElement(
            ...
            React.createElement('td', { dangerouslySetInnerHTML: { __html: plugin.description } })
          );
        });
...
var Body = React.createClass({
  ...
  componentWillMount: function componentWillMount() {
    ...
    fetch('https://raw.githubusercontent.com/brunch/skeletons/master/skeletons.json').then(function (x) {
      return x.json();
    }).then(function (x) {
  ...
  render: function render() {
    var skeletonItems = this.filteredSkeletons().map(function (skeleton, i) {
      ...
      return React.createElement(
        ...
        React.createElement('td', { dangerouslySetInnerHTML: { __html: skeleton.description } })
      );
    });
    return React.createElement(
      'div',
...
require.register("skeletons.jade", function(exports, require, module) {
var __templateData = function template(locals) {
var buf = [];
var jade_mixins = {};
var jade_interp;
