...
(function() {
    ...
    var __makeRequire = function(r, mappings, pref) {
      var none = {};
...
var Body = React.createClass({displayName: 'Body',
  ...
  render: function() {
    var pluginItems = this.categorySortedPlugins().map(function(category) {
      var catItem = React.createElement("tr", {key: category.category}, React.createElement("td", {colSpan: 2}, React.createElement("h4", null, category.category)));

      var subcatItems = category.subcategories.map(function(subcategory) {
        var subcatItem = React.createElement("tr", {key: subcategory.subcategory}, React.createElement("td", {colSpan: 2}, React.createElement("h5", null, subcategory.subcategory)));

        var pluginItems = subcategory.plugins.map(function(plugin, i) {
          var fullURL = plugin.url ? "https://github.com/" + plugin.url : null;

          return React.createElement("tr", {key: i}, 
            React.createElement("td", null, React.createElement("a", {href: fullURL, target: "_blank"}, plugin.name)), 
...
var Body = React.createClass({displayName: 'Body',
  ...
  render: function() {
    var skeletonItems = this.filteredSkeletons().map(function(skeleton, i) {
      ...
      return React.createElement("tr", {key: i}, 
        React.createElement("td", null, React.createElement("a", {href: fullURL, target: "_blank"}, skeleton.title)), 
        React.createElement("td", null, React.createElement("code", null, skeleton.url)), 
        React.createElement("td", null, React.createElement("code", null, skeleton.alias || '-')), 
        React.createElement("td", null, skeleton.technologies), 
      ...
      React.createElement("table", {className: "data-table"}, 
        React.createElement("thead", null, 
          React.createElement("tr", null, 
            ...
            React.createElement("th", null, "Technologies"), 
            React.createElement("th", null, "Description")
          )
        ), 
        React.createElement("tbody", null, 
